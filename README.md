...
테스트 **120개 통과**. 지정과제 9번의 핵심인 사전 진단은 실제 데이터로 끝까지 돕니다.
현장 참여 측정(QR·조각 보드)과 사후 리포트가 남았습니다.
...
**🟡 프론트엔드** — 기획자 화면 3개(워크스페이스 · 새 축제 · 사전 진단)까지입니다.
로그인 화면과 현장·관객 화면은 없습니다.
